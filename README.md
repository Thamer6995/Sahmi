...
> ⚠️ **حالة المشروع الحالية:** المراحل 1-4 جاهزة (إعداد المشروع، Firebase
> Auth، SahmkService، دليل الشركات + الأسعار بالجملة، القوائم المالية +
> النسب + التوزيعات، وأخيرًا بيانات OHLCV اليومية مع المؤشرات الفنية
> SMA50/SMA200/RSI14 وأعلى/أدنى 52 أسبوعًا - مع 17 اختبار وحدة).
> المراحل 5-8 (التقييم، Telegram، الواجهات، الجدولة والنشر) ستُبنى تباعًا
> - راجع قسم "خارطة الطريق" أسفله.
