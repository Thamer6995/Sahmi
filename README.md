...
> ⚠️ **حالة المشروع الحالية:** المراحل 1-3 جاهزة (إعداد المشروع، Firebase
> Auth، SahmkService، دليل الشركات + الأسعار بالجملة، والقوائم المالية +
> النسب + التوزيعات - كلها تُخزَّن في Firestore الآن).
> المراحل 4-8 (المؤشرات الفنية، التقييم، Telegram، الواجهات، الجدولة
> والنشر) ستُبنى تباعًا - راجع قسم "خارطة الطريق" أسفله.
